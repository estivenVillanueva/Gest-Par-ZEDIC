...
export const serviciosQueries = {
    ...
    async createServicio({ nombre, precio, tipo, idParqueadero }) {
        const query = `
            INSERT INTO servicios (nombre, precio, tipo, id_parqueadero)
            VALUES ($1, $2, $3, $4)
            RETURNING *
        `;
        const values = [nombre, precio, tipo, idParqueadero];
